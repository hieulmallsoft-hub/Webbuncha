    ...
    <div className="min-h-screen bg-[#FDFBF7] flex flex-col lg:flex-row overflow-hidden font-sans text-[#1A1A1A]">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-12 lg:p-24 relative slide-reveal-x" style={{"--slide-dist": "80px"}}>
        <div className="w-full max-w-md relative z-10">
          ...
          {status && (
            <div className={`mt-8 p-4 rounded-xl border ${status.includes('thất bại') || status.includes('chưa khớp') ? 'bg-red-50 border-red-100 text-red-600' : 'bg-[#6A7B53]/5 border-[#6A7B53]/10 text-[#6A7B53]'} text-xs font-bold uppercase tracking-widest text-center`}>
              {status}
            </div>
          )}
